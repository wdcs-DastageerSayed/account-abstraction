...
contract EntryPoint is IEntryPoint, StakeManager {
     ...
     * This method is expected to be called off-chain. Internally, it reverts so it doesn't really create the wallet.
    ...
    // get sender address. always revert with the result.
    // used internally by getSenderAddress
    function _getSenderAddress(bytes calldata initCode) external {
